      ...
      <div className="pt-28 px-10 pb-16">
        <div className="max-w-[1600px] mx-auto pt-2">
          ...
          <button 
            ...
            className="fixed bottom-10 right-10 w-20 h-20 bg-[#0F172A]/80 backdrop-blur-xl border border-[#CAFD00]/40 text-[#CAFD00] rounded-full shadow-[0_15px_40px_rgba(0,0,0,0.3)] flex items-center justify-center transition-all duration-300 hover:shadow-[0_20px_60px_rgba(202,253,0,0.4)] hover:border-[#CAFD00] hover:bg-[#0F172A] hover:scale-110 active:scale-95 z-50 group"
          >
          ...
          <ImageUploadDialog 
            ...
            onUpload={(files) => {
              console.log("Uploaded files from Home:", files);
              // Handle actual upload logic here (e.g., call search service)
            }}
          />
        </div>
      </div>
